...
export const Sidebar = ({ menuItems }: { menuItems: any[] }) => {
    ...
    `}
            ...
            <aside
                ...
                `}
            >
                {/* BRANDING SECTION dengan Tombol Close Internal untuk Mobile */}
                <div className="p-8 flex items-center justify-between shrink-0">
                    <div className="flex items-center gap-3 select-none">
                        {/* 1. LOGO CONTAINER (Hitung sesuai gambar: Background Hitam & Ikon Emas) */}
                        <div
                            className=" relative w-12 h-12  bg-black rounded-[18px]  overflow-hidden  flex-shrink-0 shadow-neumorph flex items-center justify-center "
                        >
                            <Image
                                src="/logotubaba.png"
                                alt="Tubaba Logo"
                        ...
                        {/* 2. TEXT SECTION (GUWAY di atas, TUBABA di bawah) */}
                        <div className="flex flex-col justify-center">
                            {/* Sub-brand GUWAY: Warna Oker/Emas Gelap, Spasi lebar */}
                            <span
                                className="text-[10px] font-bold tracking-[0.35em] leading-none mb-1.5 text-[var(--theme-base)]">
                                GUWAY
                            </span>

                            {/* Brand Utama TUBABA: Font sangat tebal (Black/Heavy), Hitam */}
                ...
                <div className="p-6 mt-auto border-t border-border-main/10 bg-surface-secondary/20 shrink-0">
                    <div className="p-4 rounded-[var(--border-radius)] bg-surface shadow-neumorph border border-white/5 space-y-4">
                        ...
                        <Button variant="danger" className="w-full justify-start gap-3 rounded-2xl group text-[10px]">
                            <LogOut size={12} className="text-danger-base" />
                            <span className="font-bold uppercase tracking-widest text-text-primary">Terminate</span>
                        </Button>
                    </div>
                </div>
            </aside>
